...
Provides an General Settings menu option to define a rel=\"me\" in metatags. See your Mastodon user profile for further instructions.

== Description ==
This Wordpress plugin  provides an *General Settings* menu option to define a rel=\"me\" in metatags. This is useful for validating personal blogs with Mastodon instances.
...
== Installation ==
Install the plugin from the Wordpress store and enable in the Plugin menu. Configure on the General Settings page.

== Changelog ==
### 1.0.2 ###
* Initial commit to Wordpress.org. See http://github.com/mckinnon for full history.